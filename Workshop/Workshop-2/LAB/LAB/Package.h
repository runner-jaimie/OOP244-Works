...
namespace sdds {
    ...
    // loads a customers structure with its values from the file
    int loadTraces();

    // allocates dynamic array of customers and loads all the file records into the array.
    int loadTraces(Customers& user);
    
    // user id in ascending
